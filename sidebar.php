        ...
        <div class="navbar-nav w-100">
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <i class="fa fa-laptop me-2" style="color: #ffffff"></i>Sign in
                </a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="signin.php" class="dropdown-item" style="color: #ffffff">Sign In</a>
                    <a href="signup.php" class="dropdown-item" style="color: #ffffff">Sign Up</a>
                </div>
            </div>
